...
func xorKeyStreamBlocksGeneric(dst, src []byte, counter *[16]byte, key *[32]byte) {
	...
	for len(src) >= 64 && len(dst) >= 64 { // check dst length to eliminate bounds check later in addXor
		...
		addXor(dst[32:36], src[32:36], x8, ctrLo)
		addXor(dst[36:40], src[36:40], x9, ctrHi)
		addXor(dst[40:44], src[40:44], x10, c10)
		addXor(dst[44:48], src[44:48], x11, c11)
		addXor(dst[48:52], src[48:52], x12, c12)
